...
export default function ClientHistoryTmvh() {
    ...
    useEffect(() => {
        ...
        const getHistory = fetch(`${apiUrl}/report-request-history`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ partnerId: partner_id, pathern: "TMVH-MO" }),
        }).then(res => res.json());
    ...
    return (
        <div style={{ padding: '40px', backgroundColor: '#FFFFFF' }}>
            <div className="max-w-7xl mx-auto">
                <center>
                    <b>
                <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">TRUEMOVE HISTORY (LAST 10 DAYS)</h1>
                </b>
                </center>
                <br/>
                <br/>
